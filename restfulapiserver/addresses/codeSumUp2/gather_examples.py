...
#python gather_examples.py --input videos/fake_001.mp4 --output dataset/fake --detector face_detector
#python gather_examples.py --input videos/zoom.mp4 --output dataset/real --detector face_detector --skip 4
